...
; ICD_END = START+$100
; this program size is just 256 bytes.
;============================================================

    ;program start
	;Error catching can be moved to their own routine if required
	;otherwise, the machine will `reset` on error to here.
EX_BusError:
EX_AddressError:
EX_IllegalInstruction:
EX_DivideBy0:
EX_CHK:
EX_TrapV:
EX_Priviledge:
